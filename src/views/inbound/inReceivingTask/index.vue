<template>
  <div>
    <ProTable
      ...
      :columns="columns"
      :requestApi="getInReceivingTaskList"
...
import { findWarehouseInfoAll, getInReceivingTaskList } from '@/api'
